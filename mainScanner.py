...
class ApplicationVulnerabilityScanner:
        ...
        def start_scan(self):
            print("Scan started on target:", self.target, ":", self.port, "using the following paramters") #"with depth:", self.scan_depth, "and aggression level:", self.aggression_level)
