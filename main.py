...
def main():
        ...
        parser.add_argument("-p", "--port", default=80, help="Set the port that the web application is running on", required=False)
        ...
        scanner = ApplicationVulnerabilityScanner(args.target, args.port, args.depth, args.aggression, args.Username, args.Password)
        scanner.start_scan()
